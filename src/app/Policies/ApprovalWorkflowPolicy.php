...
class ApprovalWorkflowPolicy
{
    ...
    {
        return $user->can('view_any_approval::workflow');
    }
    ...
    {
        return $user->can('view_approval::workflow');
    }
    ...
    {
        return $user->can('create_approval::workflow');
    }
    ...
    {
        return $user->can('update_approval::workflow');
    }
    ...
    {
        return $user->can('delete_approval::workflow');
    }
    ...
    {
        return $user->can('delete_any_approval::workflow');
    }
     ...
     */
    public function replicate(User $user, ApprovalWorkflow $approvalWorkflow): bool
    {
