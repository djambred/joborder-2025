...
class ObjectivePolicy
{
    ...
    {
        return $user->can('view_any_objective');
    }
    ...
    {
        return $user->can('view_objective');
    }
    ...
    {
        return $user->can('create_objective');
    }
    ...
    {
        return $user->can('update_objective');
    }
    ...
    {
        return $user->can('delete_objective');
    }
    ...
    {
        return $user->can('delete_any_objective');
    }
